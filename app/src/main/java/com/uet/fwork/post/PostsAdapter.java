...
//                }
        ...
        reactionRepository.isUserLikePost(post.getPostId(), firebaseUser.getUid(), new Repository.OnQuerySuccessListener<Boolean>() {
            ...
            public void onSuccess(Boolean result) {
                if (!result) {
                    holder.btnLike.setImageDrawable(context.getDrawable(R.drawable.ic_unlike));
                } else {
                    holder.btnLike.setImageDrawable(context.getDrawable(R.drawable.ic_like));
                }
            }
        });
        ...
        reactionRepository.getNumberOfReaction(post.getPostId(),
                result -> holder.txvLikeNumber.setText(result.toString()));

        commentRepository.getNumberOfComment(post.getPostId(),
                result -> holder.txvCommentNumber.setText(result.toString()));
    }
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        ImageView uAvatarIv, postImageIv, btnLike,commentButton;
