...
public class RegisterMainFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnRegisterWithGoogle = view.findViewById(R.id.btnRegisterGoogle);
        btnRegisterWithFacebook = view.findViewById(R.id.btnRegisterFacebook);
    ...
    private boolean checkUserInput() {
        ...
        String rePassword = tilConfirmPassword.getEditText().getText().toString();
        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password)
                ...
                .addOnFailureListener(exception -> {
                    ...
                    if (exception instanceof FirebaseAuthUserCollisionException) {
                        ...
                        tilPassword.setError("Mật khẩu phải chứa ít nhất 6 kí tự");
                    }
                    dialog.dismiss();
                })
                .addOnCanceledListener(() ->
